...
public class Rectangle2D
{
    ...
    public static Rectangle2D Create(Vector2D position, int height, int width)
    {
    ...
    public static Rectangle2D Create(int x, int y, int height, int width) => Create(new Vector2D(x, y), height, width);
    ...
    public static Rectangle2D Create(Vector2D a, Vector2D b)
    {
        ...
        return Create(topLeft, height, width);
    }
}